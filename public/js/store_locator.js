            ...
            if(settings.dataType === 'json' || settings.dataType === 'jsonp'){
              ...
              $.each(data, function(){
                  ...
                  if(!locationData['distance']){
                    locationData['distance'] = GeoCodeCalc.CalcDistance(orig_lat,orig_lng,locationData['lat'],locationData['long'], GeoCodeCalc.EarthRadius);
                  }
          ...
          $(function(){
             ...
             var key, value, locationData = {};
              ...
              for(var y = 0; y <= storenum; y++) {
                ...
                var point = new google.maps.LatLng(locationset[y]['lat'], locationset[y]['long']);
